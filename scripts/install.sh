...
PANEL_HOST_SYSTEMD_ETC_DIR=/host/etc/systemd/system
PANEL_HOST_SYSTEMD_UNIT_DIRS=/host/etc/systemd/system:/host/usr/lib/systemd/system:/host/lib/systemd/system
PANEL_HOST_SYSTEMD_ETC_SOURCE=/etc/systemd/system
PANEL_HOST_SYSTEMD_USR_UNIT_SOURCE=/usr/lib/systemd/system
PANEL_HOST_SYSTEMD_LIB_UNIT_SOURCE=/lib/systemd/system
